		...
		<div id="content">
			<div class="row">
				<div class="col-sm-9">
					...
					<form method="post">
					<div class="comment">
						<textarea name="content" style="height: 100px" placeholder="Mời bạn để lại bình luận"></textarea>
						<input type="submit">
					</div>
					</form>
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-caption">
											...
											<a class="beta-btn primary" href="/productdetail/{{$id->id}}">Xem chi tiết <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
